...
2. **Phone / email / address** — search for `+91 98765 43210`,
   `hello@gurumultiservices.com` and `MG Road, City Center, India` across the
...
4. **WhatsApp number** — update the `https://wa.me/919876543210` link in every
